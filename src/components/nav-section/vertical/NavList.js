...
export function NavListRoot({ list, isCollapse, handleOpenSearchDialog }) {
  ...
  return <NavItemRoot item={list} active={active} isCollapse={isCollapse} handleOpenSearch={handleOpenSearchDialog} />;
}
