            ...
            <RootStyle {...varSidebar}>
              ...
              <Scrollbar sx={{ flexGrow: 1 }}>
                <Stack spacing={3} sx={{ p: 3 }}>
                  ...
                  <Stack spacing={1.5}>
                    <Typography variant="subtitle2">{translate("Direction")}</Typography>
                    <SettingDirection />
                  </Stack>

                  <Stack spacing={1.5}>
                    <Typography variant="subtitle2">{translate("Layout")}</Typography>
                    <SettingLayout />
                  </Stack>

                  <Stack spacing={1.5}>
                    <Typography variant="subtitle2">{translate("Presets")}</Typography>
                    <SettingColorPresets />
                  </Stack>

                  <Stack spacing={1.5}>
                    <Typography variant="subtitle2">{translate("Stretch")}</Typography>
                    <SettingStretch />
                  </Stack>
